  ...
  render() {
    return (
      <div className='container'>
        ...
        <p>
          The CYOA has a nested tree structure which is mapped over using recursive and iterative depth first methods (for developer experience) which take a match function, execution function, and a data store. The <a target="_blank" href='https://github.com/substack/js-traverse'>traverse library</a> is used for direct setting of values in the tree. Variable and default variables are copied to state, with relevant values copied to components to avoid unnecessary re-rendering.  Performance does suffer when the CYOA become large and further performance considerations could be taken.  
        </p>
        <p>
